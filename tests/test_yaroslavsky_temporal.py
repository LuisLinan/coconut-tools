...
@pytest.mark.bigdata
def test_yaroslavsky_temporal_pipeline(tmp_path: Path):
    """End-to-end temporal GONG pipeline for the Yaroslavsky filter."""
    os.environ.setdefault("MPLBACKEND", "Agg")

    outdir = tmp_path / "yaroslavsky"
    rawdir = tmp_path / "raw"
    ...
    map_type = "GONG"
    lmax = 3
    output_path_fig = outdir / "gong_yaroslavsky_20110904T120000.png"
