...
def build_gif_and_video(config: MediaConfig) -> None:
    ...
    mp4_path = output_dir / f"{config.prefix}_timeline.mp4"
    gif_path = output_dir / f"{config.prefix}_timeline.gif"
...
if __name__ == "__main__":
    ...
    prefix = ["bclt","blon","br","vr","nscaled"]
    prefix =  ["bclt","blon","br","vr","nscaled"]
    
    for pre in prefix:
        config = MediaConfig(
            input_dir=Path(r"E:/euhforia/image/fcomp_d_e/image"),
            output_dir=None,
            prefix=pre,
            extension="png",
            fps=3.0,
    ...
    for pre in prefix:
        config = MediaConfig(
            input_dir=Path(r"E:/euhforia/image/ref/image"),
            output_dir=None,
            prefix=pre,
            extension="png",
            fps=3.0,
    ...
    for pre in prefix:
        config = MediaConfig(
            input_dir=Path(r"E:/euhforia/image/fcomp/image"),
            output_dir=None,
            prefix=pre,
            extension="png",
            fps=3.0,
    ...
    for pre in prefix:
        config = MediaConfig(
            input_dir=Path(r"E:/euhforia/image/fcomp_d/image"),
            output_dir=None,
            prefix=pre,
            extension="png",
            fps=3.0,
